    ...
    <div class="card-body">
        <form method="post" action="{{ route('user.store') }}">
            ...
            <div class="form-group">
                ...
                <input id="inputTitle" type="email" name="email" placeholder="Enter email" value="{{ old('email') }}"
                    class="form-control">
                @error('email')
                <span class="text-danger">{{$message}}</span>
                @enderror
            ...
            <div class="form-group">
                <label for="inputTitle" class="col-lg-4 col-form-label">Password <span
                        class="text-danger">*</span></label>
                <input id="inputTitle" type="password" name="password" placeholder="Enter password"
