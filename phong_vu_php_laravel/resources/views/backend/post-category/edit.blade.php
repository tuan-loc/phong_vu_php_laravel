...
@section('title','Phong Vũ || Post Category Edit')
...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{ route('post-category.update', ['id' => $postCategory->id]) }}">
                @csrf
                <div class="form-group">
                    ...
                    <input id="inputTitle" type="text" name="name" placeholder="Enter name"
                        value="{{ $postCategory->name }}" class="form-control">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="inactive" {{(($postCategory->status=='inactive')? 'selected' : '')}}>Inactive
                        </option>
                    </select>
                    @error('status')
                    <span class="text-danger">{{$message}}</span>
